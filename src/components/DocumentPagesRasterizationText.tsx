import usePageRasterizationWithText from "~/hooks/usePageRasterizationWithText";

let lastZoom = 2;

const DocumentPagesRasterizationText: React.FC<{ currentPage: number }> = ({ currentPage }) => {
  const [canvasRef, preRenderRef, articleRef, containerRef, scale, setScale] = usePageRasterizationWithText(currentPage, lastZoom);
...
export default DocumentPagesRasterizationText;
