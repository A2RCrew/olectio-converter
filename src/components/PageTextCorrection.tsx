...
import useCustomCorrection from '~/hooks/useCustomCorrection';

const PageTextCorrection: React.FC<{ currentPage: number }> = ({ currentPage }) => {
  const [text, setText] = usePageText(currentPage);
  const  [response, correct] = useCustomCorrection(text);
...
export default PageTextCorrection;
